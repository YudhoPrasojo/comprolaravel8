...
@include('/layout/new/head')

<body class="index-page">
    @include('/layout/new/header')
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <img src="{{ asset('assets_dewi/assets/img/hero-bg.jpg') }}" alt="" data-aos="fade-in">
    ...
    @include('/layout/new/footer')
    @include('/layout/new/js')
</body>
